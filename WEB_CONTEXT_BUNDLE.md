...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-644-erd-s-problem-644-d0087801-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-644"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-644-erd-s-problem-644-d0087801-v1",
      "problem_contract_sha256": "e5e6f0c4a32f85c05c25243015dd6048ccdd104d9a6dc97273b1377bb2a5207f",
      "problem_id": "problem:um-ep-644-erd-s-problem-644-d0087801",
      "route_id": "route:um-ep-644-erd-s-problem-644-d0087801-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-644-erd-s-problem-644-d0087801-source-fidelity-01",
      "graph_id": "graph:um-ep-644-erd-s-problem-644-d0087801-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-644-erd-s-problem-644-d0087801-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-644-erd-s-problem-644-d0087801-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f(k,r)$ be minimal such that if $A_1,A_2,\\ldots$ is a family of sets, all of size $k$, such that for every collection of $r$ of the $A_is$ there is some pair $\\{x,y\\}$ which intersects all of the $A_j$, then there is some set of size $f(k,r)$ which intersects all of the sets $A_i$. Is it true that $ f(k,7)=(1+o(1))\\frac{3}{4}k? $ Is it true that for any $r\\geq 3$ there exists some constant $c_r$ such that $ f(k,r)=(1+o(1))c_rk? $"
          },
          "statement_sha256": "5fd9550134acb2a109a7137f6c59837cd6608b5cdba6e56e6bd27841a6e1c333"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-644-erd-s-problem-644-d0087801-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-644-erd-s-problem-644-d0087801-root",
      "route_id": "route:um-ep-644-erd-s-problem-644-d0087801-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-644-ed8cbb93368c",
        "url": "https://www.unsolvedmath.com/problems/EP-644"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
